...
/// Persists the pairing state produced by the /verify + /api/verify flow,
/// plus simple user prefs. See bot.py: cmd_verify_app / handle_verify_api.
